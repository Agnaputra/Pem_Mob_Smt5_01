...
void main() {
  ...
  // Isi data
  list[0] = "Agna Putra Prawira";  // ganti dengan nama kamu
  list[1] = "2341720065";          // ganti dengan NIM kamu
...
so it can only hold nulls. When you fill it with "Agna" or "2341720065," 
...
void main() {
  ...
  // Isi data
  list[0] = "Agna Putra Prawira";  // Nama
  list[1] = "2341720065";          // NIM
...
void main() {
  ...
  names1.add('Agna Putra Prawira');      // Replace with your name
  names1.add('2341720065');  // Replace with your student ID

  // Add elements to the second set using .addAll()
  names2.addAll(['Agna Putra Prawira', '2341720065']); // Replace with your details
...
void main() {
  ...
  gifts['nama'] = 'Agna Putra Prawira';
  gifts['nim'] = '2341720065';
...
mahasiswa = ('Agna Putra Prawira', '2341720065');
...
var mahasiswa2 = ('Agna Putra Prawira', nim: '2341720065', active: true, 'IK-1E');
...
void main() {
  ...
  print(sayHello('Agna')); // Output: Hello, Agna!
}
```
Output:
...
printIdentity('Agna Putra Prawira', '2341720065'); 
}
```
...
void main() {
  ...
  print(helloGreeter('Agna'));    // Output: Hello, Agna!
  print(morningGreeter('Agna')); // Output: Good morning, Agna!
}
```
Output:
...
(String, int) getMahasiswa() {
  String name = 'Agna Putra Prawira';
  int entryYear = 2023;
